...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Leavestype'), ['action' => 'edit', $leavestype->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Leavestype'), ['action' => 'delete', $leavestype->id], ['confirm' => __('Are you sure you want to delete # {0}?', $leavestype->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Leavestypes'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Leavestype'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
